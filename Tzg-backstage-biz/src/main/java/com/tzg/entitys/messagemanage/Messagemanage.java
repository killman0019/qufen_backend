package com.tzg.entitys.messagemanage;
...
public class Messagemanage implements Serializable {
	...
	private java.lang.Integer numSend;

	private java.lang.Integer numRead;
	...
	private Date dtLastRepayStart;// 最后一笔回款开始时间
    private String dtLastRepayStartStr;
    private Date dtLastRepayEnd;//最后一笔回款束时间
    private String dtLastRepayEndStr;
    private BigDecimal minTotalAsset;// 最小账户总资产
    private BigDecimal maxTotalAsset;// 最大账户总资产
    
    public Date getDtLastRepayStart() {
        return dtLastRepayStart;
    }

    public void setDtLastRepayStart(Date dtLastRepayStart) {
        this.dtLastRepayStartStr = DateUtil.getDate(dtLastRepayStart, "yyyy-MM-dd");
        this.dtLastRepayStart = dtLastRepayStart;
    }

    public String getDtLastRepayStartStr() {
        return dtLastRepayStartStr;
    }

    public void setDtLastRepayStartStr(String dtLastRepayStartStr) {
        this.dtLastRepayStart = DateUtil.getDate(dtLastRepayStartStr, "yyyy-MM-dd");
        this.dtLastRepayStartStr = dtLastRepayStartStr;
    }

    public Date getDtLastRepayEnd() {
        return dtLastRepayEnd;
    }

    public void setDtLastRepayEnd(Date dtLastRepayEnd) {
        this.dtLastRepayEndStr = DateUtil.getDate(dtLastRepayEnd, "yyyy-MM-dd");
        this.dtLastRepayEnd = dtLastRepayEnd;
    }

    public String getDtLastRepayEndStr() {
        return dtLastRepayEndStr;
    }

    public void setDtLastRepayEndStr(String dtLastRepayEndStr) {
        this.dtLastRepayEnd = DateUtil.getDate(dtLastRepayEndStr, "yyyy-MM-dd");
        this.dtLastRepayEndStr = dtLastRepayEndStr;
    }

    public BigDecimal getMinTotalAsset() {
        return minTotalAsset;
    }

    public void setMinTotalAsset(BigDecimal minTotalAsset) {
        this.minTotalAsset = minTotalAsset;
    }

    public BigDecimal getMaxTotalAsset() {
        return maxTotalAsset;
    }

    public void setMaxTotalAsset(BigDecimal maxTotalAsset) {
        this.maxTotalAsset = maxTotalAsset;
    }
	...
	public void setDtRegisterStart(Date dtRegisterStart) {
		this.dtRegisterStartStr = DateUtil.getDate(dtRegisterStart,
				"yyyy-MM-dd");
	...
	public void setDtRegisterStartStr(String dtRegisterStartStr) {
		this.dtRegisterStart = DateUtil.getDate(dtRegisterStartStr,
				"yyyy-MM-dd");
	...
	public void setDtLastLoginStart(Date dtLastLoginStart) {
		this.dtLastLoginStartStr = DateUtil.getDate(dtLastLoginStart,
				"yyyy-MM-dd");
	...
	public void setDtLastLoginStartStr(String dtLastLoginStartStr) {
		this.dtLastLoginStart = DateUtil.getDate(dtLastLoginStartStr,
				"yyyy-MM-dd");
	...
	public void setDtLastRechargeStart(Date dtLastRechargeStart) {
		this.dtLastRechargeStartStr = DateUtil.getDate(dtLastRechargeStart,
				"yyyy-MM-dd");
	...
	public void setDtLastRechargeStartStr(String dtLastRechargeStartStr) {
		this.dtLastRechargeStart = DateUtil.getDate(dtLastRechargeStartStr,
				"yyyy-MM-dd");
	...
	public void setDtLastRechargeEnd(Date dtLastRechargeEnd) {
		this.dtLastRechargeEndStr = DateUtil.getDate(dtLastRechargeEnd,
				"yyyy-MM-dd");
	...
	public void setDtLastRechargeEndStr(String dtLastRechargeEndStr) {
		this.dtLastRechargeEnd = DateUtil.getDate(dtLastRechargeEndStr,
				"yyyy-MM-dd");
	...
	public void setDtLastInvestStart(Date dtLastInvestStart) {
		this.dtLastInvestStartStr = DateUtil.getDate(dtLastInvestStart,
				"yyyy-MM-dd");
	...
	public void setDtLastInvestStartStr(String dtLastInvestStartStr) {
		this.dtLastInvestStart = DateUtil.getDate(dtLastInvestStartStr,
				"yyyy-MM-dd");
	...
	public void setDtLastInvestEnd(Date dtLastInvestEnd) {
		this.dtLastInvestEndStr = DateUtil.getDate(dtLastInvestEnd,
				"yyyy-MM-dd");
	...
	public void setDtLastInvestEndStr(String dtLastInvestEndStr) {
		this.dtLastInvestEnd = DateUtil.getDate(dtLastInvestEndStr,
				"yyyy-MM-dd");
	...
	public java.lang.Integer getNumSend() {
		return numSend;
	}

	public void setNumSend(java.lang.Integer numSend) {
		this.numSend = numSend;
	}

	public java.lang.Integer getNumRead() {
		return numRead;
	}

	public void setNumRead(java.lang.Integer numRead) {
