...
public class CoinProperty implements Serializable {
	...
	private Double lastMonthCoinLock;

	public Double getLastMonthCoinLock() {
		return lastMonthCoinLock;
	}

	public void setLastMonthCoinLock(Double lastMonthCoinLock) {
		this.lastMonthCoinLock = lastMonthCoinLock;
	}
