...
public class MobileService {
	...
	public static void init(String sn, String pwd, String mtURL) {
		...
		MobileService.md5pwd = MD5Util.md5Hex(MobileService.sn + MobileService.pwd).toUpperCase();
		MobileService.mtURL = mtURL;
	}

	public static String sendSms(Smssend smsSend) throws Exception {
		return sendMSG(smsSend.getVcPhone(), smsSend.getVcContent(), 3 == (smsSend.getItype().intValue()) ? "1" : null, null, null, null);
	}

	public static String sendMSG(String mobile, String content, String ext, String stime, String rrid, String msgfmt) throws Exception {
		...
		params.add(new NameValuePair("content", URLEncoder.encode(content, "utf-8")));
		...
		String responseStr = sendHttpMsg(mtURL, params.toArray(new NameValuePair[params.size()]));
	...
	public static String sendMSGByJZ(String destmobile, String msgText) throws Exception {
	...
	private static String sendHttpMsg(String url, NameValuePair[] params) throws Exception {
		String result = null;
		HttpClient client = new HttpClient();
