...
public class RegexUtil {
	 ...
	 * 身份证号码
	 */
	public static final String IDCARD = "(^([0-9]{17})([0-9Xx]{1})$)|(^([0-9a-zA-Z]{8})\\-([0-9a-zA-Z]{1})$)";
	/**
	 * 手机号码 移动：134、135、136、137、138、139、150、151、157、158、159、182、187、188
	 * 联通：130、131、132、152、155、156、185、186 电信：133、153、180、189、 177
	 * 177是电信4G专属号段，联通176，移动178，虚拟运营商170。新加166
	 */
	// public static final String PHONEREGEX =
	// "^[1]([2-3][0-9]{1}|45|47|[5][0-3]{1}|[5][5-9]{1}|70|71|73|[7][6-8]{1}|[8][0-9]{1})[0-9]{8}$";
	public static final String PHONEREGEX = "^((13[0-9])|(14[5,7])|(15[0-3,5-9])|(17[0,1,3,5-8])|(18[0-9])|166|198|199|(147))\\d{8}$";
	 ...
	 */
	public static final String PASSWORD_LOGIN_REGISTER = "^(?![0-9]+$)(?![a-zA-Z]+$)[0-9A-Za-z]{8,16}$";
