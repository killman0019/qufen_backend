...
public class RegexUtil {
	 ...
	 * 联通：130、131、132、152、155、156、185、186 电信：133、153、180、189、 177 177是电信4G专属号段，联通176，移动178，虚拟运营商170。新加166
	 */
	//public static final String PHONEREGEX = "^[1]([2-3][0-9]{1}|45|47|[5][0-3]{1}|[5][5-9]{1}|70|71|73|[7][6-8]{1}|[8][0-9]{1})[0-9]{8}$";
	public static final String PHONEREGEX = "^(13[0-9]|14[579]|15[0-3,5-9]|16[6]|17[0135678]|18[0-9]|19[89])\\d{8}$";
