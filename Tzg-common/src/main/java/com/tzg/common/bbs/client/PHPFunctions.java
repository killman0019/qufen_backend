...
public abstract class PHPFunctions {
	...
	protected String urlencode(String value){
		String r = null;
		try {
			r =  URLEncoder.encode(value,"utf-8");
	...
	protected String call_user_func(String function, String model, String action, Map<String,Object> args) throws Exception {
	...
	public abstract String uc_api_post(String $module, String $action, Map<String,Object> $arg ) throws Exception ;
