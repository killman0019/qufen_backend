package com.tzg.common.bbs.client;
...
public class Client extends PHPFunctions {
    ...
    public String uc_api_post(String $module, String $action, Map<String, Object> $arg) throws Exception {
        ...
        String result = uc_fopen2(UC_API + "/index.php", 500000, $postdata, "", true, UC_IP, 20, true);
        return result;
    }
    ...
    public String uc_authcode(String $string, String $operation, String $key, int $expiry) {
        ...
        $string = $operation.equals("DECODE") ? base64_decode(substr($string, $ckey_length)) : sprintf("%010d", $expiry > 0 ? $expiry + time() : 0)
     ...
     *  @return			取到的字符串
     */
    protected String uc_fopen2(String $url, int $limit, String $post, String $cookie, boolean $bysocket, String $ip, int $timeout, boolean $block) throws Exception {
    ...
    protected String uc_fopen(String $url, int $limit, String $post, String $cookie, boolean $bysocket, String $ip, int $timeout, boolean $block) throws Exception {
        String $return = "";
        ...
        try {
            socket.connect(new InetSocketAddress($ip != null && $ip.length() > 10 ? $ip : $host, $port), 1500);
            ...
            if (!socket.isClosed() && socket.isConnected())
                logger.info("读取超时，放弃操作");
            else
                logger.info("连接超时，放弃操作");
        } catch (IOException e) {
            logger.error(e);
        }
        return $return;
    ...
    public String uc_app_ls() throws Exception {
     ...
     * @return int
    	...
    	>1 : 表示成功，数值为 UID
    */
    public String uc_user_register(String $username, String $password, String $email) throws Exception {
        return uc_user_register($username, $password, $email, "", "");
    }

    public String uc_user_register(String $username, String $password, String $email, String $questionid, String $answer) throws Exception {
     ...
     * @return array (uid/status, username, password, email)
    	...
    	-2 : 密码错
    */
    public String uc_user_login(String $username, String $password) throws Exception {
        return uc_user_login($username, $password, 0, 0);
    }

    public String uc_user_login(String $username, String $password, int $isuid, int $checkques) throws Exception {
        return uc_user_login($username, $password, $isuid, $checkques, "", "");
    }

    public String uc_user_login(String $username, String $password, int $isuid, int $checkques, String $questionid, String $answer) throws Exception {
        Map<String, Object> args = new HashMap<String, Object>();
        args.put("username", $username);
        args.put("password", $password);
     ...
     */
    public String uc_user_synlogin(int $uid) throws Exception {
        Map<String, Object> args = new HashMap<String, Object>();
        args.put("uid", $uid);
     ...
     * @return string 		HTML代码
     */
    public String uc_user_synlogout() throws Exception {
     ...
     */
    public String uc_get_user(String $username, int $isuid) throws Exception {
        Map<String, Object> args = new HashMap<String, Object>();
        args.put("username", $username);
        args.put("isuid", $isuid);
     ...
     * @return int
    	...
    	-8 : 受保护的用户，没有权限修改
    */
    public String uc_user_edit(String $username, String $oldpw, String $newpw, String $email, int $ignoreoldpw, String $questionid, String $answer) throws Exception {
        Map<String, Object> args = new HashMap<String, Object>();
        args.put("username", $username);
     ...
     * @return int
     	...
     	0 : 失败
     */
    public String uc_user_delete(String $uid) throws Exception {
        Map<String, Object> args = new HashMap<String, Object>();
        args.put("uid", $uid);
     ...
     * @param string/array $uid	用户的 UID
     */
    public String uc_user_deleteavatar(String $uid) throws Exception {
        Map<String, Object> args = new HashMap<String, Object>();
        args.put("uid", $uid);
        return uc_api_post("user", "deleteavatar", args);
    }

    public static String getUC_IP() {
        return UC_IP;
    }

    public static void setUC_IP(String uC_IP) {
        UC_IP = uC_IP;
    }

    public static String getUC_API() {
        return UC_API;
    }

    public static void setUC_API(String uC_API) {
        UC_API = uC_API;
    }

    public static String getUC_CONNECT() {
        return UC_CONNECT;
    }

    public static void setUC_CONNECT(String uC_CONNECT) {
        UC_CONNECT = uC_CONNECT;
    }

    public static String getUC_KEY() {
        return UC_KEY;
    }

    public static void setUC_KEY(String uC_KEY) {
        UC_KEY = uC_KEY;
    }

    public static String getUC_APPID() {
        return UC_APPID;
    }

    public static void setUC_APPID(String uC_APPID) {
        UC_APPID = uC_APPID;
    }
