...
define(function (require, exports, module) {
	...
	var $form = $("#j_forget_password_form");
	...
	$sendCaptchaBtn.countdown({
		...
		request: {
			url: basePath + "/dynamicValidateCode/sendToExistAccount",
			data: {phone: function(){return $phone.val();}, bus: 'forgetPassword'}
		}
	});
