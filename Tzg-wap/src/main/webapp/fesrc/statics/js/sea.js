...
var basePath = byId("j_basepath").getAttribute("content");
var staticPath = byId("j_staticpath").getAttribute("content");
...
// 		"module": staticPath + "/js/modules",
// 		"page": staticPath + "/js/pages"
// 	},
// 	alias: {
