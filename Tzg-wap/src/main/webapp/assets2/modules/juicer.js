...
(function( factory ){
    ...
    if( require ) {
        ...
        //计算字符串长度
//        juicer.register('strLength', tools.strLength);
//        
//        juicer.register('formattedNumber', tools.formattedNumber);
//        juicer.register('parseJudgePre', tools.parseJudgePre);
//        juicer.register('formatDate', tools.formatDate);

        // 去掉完整时间格式中的日期部分
        juicer.register("toTime", function (str) {
            return str.substr(10);
        });

        juicer.register('toCurrency', function (num) {   
        ...
        juicer.register('substr', function(str, start, len) {
        	return str.substr(start || 0, len || null);
        });
    }
