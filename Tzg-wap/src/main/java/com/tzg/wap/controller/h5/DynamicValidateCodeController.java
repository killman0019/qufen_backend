...
public class DynamicValidateCodeController extends BaseController {
	...
	// @ResponseBody
	// public BaseResponseEntity sendencrypt(HttpServletRequest request, HttpServletResponse
	// response, String phone, String module) {
	...
	// }
	// String cacheKey = new
	// StringBuffer(RestConstants.key_rest).append(module).append(phone).toString();
	...
	// @ResponseBody
	// public BaseResponseEntity verify(HttpServletRequest request, HttpServletResponse response,
	// String phone, String module, String code) {
	// BaseResponseEntity bre = new BaseResponseEntity();
	// try {
