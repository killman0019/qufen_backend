...
public class AuthorityAnnotationInterceptor extends HandlerInterceptorAdapter {
	 ...
	 * 
	 */
	private boolean preparedSessionUser(HttpServletRequest request, HttpServletResponse response) throws Exception, ServletException {
		...
		if (loginAccount == null) {
			...
			if (StringUtils.isNotBlank(currentURL) && currentURL.indexOf("/list") == -1 && currentURL.indexOf("/app/subject") == -1
					&& currentURL.indexOf("/app/article") == -1 && currentURL.indexOf("/app/investRecord") == -1
	...
	private void logUerOperation(HttpServletRequest request, HttpServletResponse response, Exception ex) {
