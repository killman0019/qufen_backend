 ...
 * @Description: TODO
 * @author chy@tzg.cn
 * @date 2014-12-29 下午12:41:54
 */
public class SystemUtils {

    public static final String MESSAGE_FILE     = "message";
    public static final String APPLICATION_FILE = "system-rest";
     ...
     * @return
     */
    public static ResourceBundle readConfig(String configFileName) {
    ...
    public static String getSiteEnvValue(String key) {
        String value = "";
        try {
            Properties props = PropertiesLoaderUtils.loadAllProperties("system-rest.properties");
    ...
    public static void main(String[] args) {
        System.out.println(String.format("%011d", 12));
        // System.out.println(getAppConfig("static.file.server.url"));
    }
}
